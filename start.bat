...
wt -w 0 nt --title "Claude Signal Bridge" -d "C:\users\jokky\documents\claude-signal-bridge\host" cmd /k "set BRIDGE_SECRET=%BRIDGE_SECRET%&& set PROJECT_DIR=%PROJECT_DIR%&& node index.js"
